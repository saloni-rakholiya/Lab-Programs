# from node 0 to 4 and node 1 to 3
BEGIN{
  totalsent=0
  totalreceived=0
  sent10=0
...
END{
  ...
  printf("%f %f\n",10,(sent10-received10)/sent10);
  printf("%f %f\n",20,(sent20-received20)/sent20);
  printf("%f %f\n",30,(sent30-received30)/sent30);
  printf("%f %f\n",40,(sent40-received40)/sent40);
  printf("%f %f\n",50,(sent50-received50)/sent50);
